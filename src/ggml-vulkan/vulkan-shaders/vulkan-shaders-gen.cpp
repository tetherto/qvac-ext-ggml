...
void process_shaders() {
    ...
    string_to_spv("convrot_convert_f16_f32", "convrot_convert.comp", {{"SRC_F16", "1"}});
    string_to_spv("convrot_round_f16", "convrot_convert.comp", {{"ROUND_F16", "1"}});
    string_to_spv("rope_flux_f32", "rope_flux.comp", {});
    string_to_spv("convrot_convert_i8_f16", "convrot_convert.comp", {{"SRC_I8", "1"}, {"DST_F16", "1"}});
    string_to_spv("convrot_activation_split_f32", "convrot_activation_split.comp", {});
    string_to_spv("convrot_activation_split_f16", "convrot_activation_split.comp", {{"SRC_F16", "1"}});
    string_to_spv("convrot_combine", "convrot_combine.comp", {});
    string_to_spv("convrot_tile_weights", "convrot_tile.comp", {{"SRC_I8", "1"}});
    string_to_spv("convrot_tile_activation", "convrot_tile.comp", {});
    string_to_spv("convrot_accumulate", "convrot_accumulate.comp", {});
